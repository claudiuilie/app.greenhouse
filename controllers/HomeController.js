...
class HomeController {
    ...
    static async getGreenhouseStatus() {
    ...
    static async getGreenhouseTempHistory(greenhouseHistory) {
    ...
    static async getGreenhouseHumHistory(greenhouseHistory) {
    ...
    static async getGreenhouseSoilHistory1(greenhouseHistory) {
    ...
    static async getGreenhouseSoilHistory2(greenhouseHistory) {
    ...
    static async getWaterTankLevel(greenhouseStatus) {
